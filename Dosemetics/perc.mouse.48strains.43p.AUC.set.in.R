...
SetPoints (
"perc.mouse.48strains.43p.random.1.AUC.set.out",
...
Print( AUCCKid , 36 );
Data( AUCCKid , -1);
Print( AUCCPlasTCA , 36 );
Data( AUCCPlasTCA , -1);
Print( AUCCPlasTCAFree , 36 );
Data( AUCCPlasTCAFree , -1);
Print( AUCCLivTCA , 36 );
Data( AUCCLivTCA , -1);
Print( AUCCKidTCA , 36 );
Data( AUCCKidTCA , -1);
Print( AUCCBldTCVG , 36 );
Data( AUCCBldTCVG , -1);
Print( AUCCLivTCVG , 36 );
Data( AUCCLivTCVG , -1);
Print( AUCCKidTCVG , 36 );
Data( AUCCKidTCVG , -1);
Print( AUCCBldTCVC , 36 );
Data( AUCCBldTCVC , -1);
Print( AUCCLivTCVC , 36 );
Data( AUCCLivTCVC , -1);
Print( AUCCKidTCVC , 36 );
Data( AUCCKidTCVC , -1);
Print( AUCCBldNAT , 36 );
Data( AUCCBldNAT , -1);
Print( AUCCLivNAT , 36 );
