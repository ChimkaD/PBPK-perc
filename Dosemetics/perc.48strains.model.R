...
##-- Metabolism
  ...
  AMetKidNAT, # Amount mercapturate in kidney
  AMetKidDCA, # Amount bioactivated in kidney
##-- Other Dose metrics
	AUCCBld,	#(vrisk)
	AUCCLiv,	#(vrisk)
	AUCCKid,	#(vrisk)
...
#*** Outputs that are potential dose metrics
  ...
  TotTissueBW34, #(vrisk) Total tissue Perc / BW^3/4
  ...
  TotTCAInBW34, #(vrisk) TCA production / BW^3/4
  TCAProLivBW34, #(vrisk) mg TCA produced in liver / BW^3/4
  ...
  AMetLiv2BW34, # Amount metabolized by GSH conjugation liver/BW^3/4 
  #	AMetKid2,	# Amount metabolized by GSH conjugation kidney	
  AMetKid2BW34,	# Amount metabolized by GSH conjugation kidney/BW^3/4
  #	AMetKidTCVC, # Amount metabolized by cysteine conjugation kidney
  AMetKidTCVCBW34, # Amount metabolized by cysteine conjugation kidney/BW^3/4
...
# Total metabolized
	...
	dt(AMetKidNAT) = RAMetKidNAT; 
	dt(AMetKidDCA) = RAMetKidDCA; 
	ATotMetLiv = AMetLiv1 + AMetLiv2; #
	ATotMetKid = AMetKid1 + AMetKid2 + AMetKidTCVC + AMetKidNAT + AMetKidDCA; #
	TotMetab = AMetLng + ATotMetLiv + ATotMetKid; #
	TCAProLiv = (1 - FracOther)*StochTCAPERC*AMetLiv1;
...
#	TotATCVGPro = StochTCVGPERC * (AMetLiv2 + AMetKid2);
	TotTCVGPro = StochTCVGPERC * (AMetLiv2 + AMetKid2);
#	TotTCVCPro = StochTCVCTCVG * RAMetKidTCVC;
#	TotATCVCPro = StochTCVCTCVG * AMetKidTCVC;
	TotTCVCPro = StochTCVCTCVG * AMetKidTCVC;
